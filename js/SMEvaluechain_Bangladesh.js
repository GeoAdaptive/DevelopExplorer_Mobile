...
var BangCountryUrl = 'https://github.com/GeoAdaptive/DevelopExplorer_V5/blob/master/data/BGD_adm0.geojson';
var BangRailsUrl = 'https://raw.githubusercontent.com/GeoAdaptive/DevelopExplorer_V5/master/data/bgd_rails.geojson';

//CREATE THE GEO OBJECTS
var parsedData_bangcountry;
var parsedData_bangrails;
...
//some comment on operational demand


//DOWNLOAD AND PARSE THE DATA: HONDURAS MAJOR ROADS
var BangCountryUrl = 'https://github.com/GeoAdaptive/DE_V3/blob/master/data/BGD_adm0.geojson';
var BangRailsUrl = 'https://raw.githubusercontent.com/GeoAdaptive/DE_V3/master/data/bgd_rails.geojson';
...
$(document).ready(function(){
  $.ajax(BangCountryUrl).done(function(data){
    parsedData_bangcountry = JSON.parse(data);
    console.log(parsedData_bangcountry);
    console.log("parsed");

    var itemB = L.geoJson(parsedData_bangcountry,
      {
        style: {opacity:0.7,color:'#212F3D',fillOpacity:0.7},
        ...
        bangcountry.push(itemB);
        console.log("Bangladesh country shape generated.");
  })
})

$(document).ready(function(){
  $.ajax(BangRailsUrl).done(function(data){
    parsedData_bangrails = JSON.parse(data);
    console.log(parsedData_bangrails);
    console.log("parsed");

    var itemB = L.geoJson(parsedData_bangrails,
      {
        style: {opacity:0.7,width:0.5,color:'#000000',fillOpacity:0.7},
        pointToLayer: function (feature, latlng) {
        ...
        itemB.eachLayer(eachFeatureFunction);
        bangrails.push(itemB);
        console.log("Bangladesh railways shape generated.");
  })
})
