...
//ADD THE RASTER DATA
//method 1
//directly paste image to the map
var b1, b2;

$('#gaptitle8').click(function(){
  x = x + 1;
  if (x % 2 == 1) {
    document.getElementById("ramptitle").style.display = "block";
    document.getElementById("coloramp_uhi").style.display = "block";
    document.getElementById("ramptitle").style.visibility = "visible";
    document.getElementById("coloramp_uhi").style.visibility = "visible";

  } else {
    document.getElementById("ramptitle").style.display = "none";
    document.getElementById("coloramp_uhi").style.display = "none";
    document.getElementById("ramptitle").style.visibility = "none";
    document.getElementById("coloramp_uhi").style.visibility = "none";
  ...
  if(document.getElementById('g8b').style.display == "block"){
    ...
    var imagebldgUrl = 'opportunities2_transp.png',
    imagebldgBounds = [[-26.259401, -55.533560], [-23.964157, -52.599596]];
    var imageOverlay = L.imageOverlay(imagebldgUrl, imagebldgBounds);
    imageOverlay.addTo(map);

    _.each(OP_boundary,function(layer){
      map.removeLayer(layer);
    });

    _.each(AP_boundary,function(layer){
      map.removeLayer(layer);
    });

    _.each(Sevendist,function(layer){
      map.removeLayer(layer);
    });

    _.each(OP_muni,function(layer){
      map.removeLayer(layer);
    });

    _.each(AP_muni,function(layer){
      map.removeLayer(layer);
    });
  }
})
...
$('#gaptitle9').click(function(){
  y = y + 1;
  if (y % 2 == 1) {
    document.getElementById("ramptitle1").style.display = "block";
    document.getElementById("coloramp_uhi1").style.display = "block";
    document.getElementById("ramptitle1").style.visibility = "visible";
    document.getElementById("coloramp_uhi1").style.visibility = "visible";
  } else {
    document.getElementById("ramptitle1").style.display = "none";
    document.getElementById("coloramp_uhi1").style.display = "none";
    document.getElementById("ramptitle1").style.visibility = "none";
    document.getElementById("coloramp_uhi1").style.visibility = "none";
  ...
  if(document.getElementById('g9b').style.display == "block"){
    ...
    _.each(imageOverlay,function(layer){
      map.removeLayer(layer);
    });
    console.log("image removed");
    ...
    var imagebldgUrl = 'challenges2_transp.png',
    imagebldgBounds = [[-26.259401, -55.533560], [-23.964157, -52.599596]];
    var imageOverlay = L.imageOverlay(imagebldgUrl, imagebldgBounds).addTo(map);
...
// browserify mappingpage_border.js -o bundle.js;
...
//NORTHERN TRIANGLE
var Hondurasurl = 'https://raw.githubusercontent.com/GeoAdaptive/DE_V3/master/data/hnd_boundary_adm0.geojson';
...
var Haitiurl = 'https://github.com/GeoAdaptive/DE_V3/blob/master/data/hti_adm0_3.geojson';
var Dominicanurl = 'https://raw.githubusercontent.com/GeoAdaptive/DE_V3/master/data/dom_adm0.geojson';
...
//OP MUNICIPALITY URL
var OP_muniurl ='https://raw.githubusercontent.com/GeoAdaptive/DE_V3/master/data/adm_municipios_op_ibge_2015_bra.geojson';
var parsedData_OPmuni;
var OP_muni = [];

//AP MUNICIPALITY URL
var AP_muniurl ='https://raw.githubusercontent.com/GeoAdaptive/DE_V3/master/data/ap_muni.geojson';
var parsedData_APmuni;
var AP_muni = [];
...
var PortsUrl = 'https://raw.githubusercontent.com/GeoAdaptive/DE_V3/master/data/ports_apop.geojson';
...
var MiddleSchoolsUrl = 'https://raw.githubusercontent.com/GeoAdaptive/DE_V3/master/data/mid_school.geojson';
var SupSchoolsUrl = 'https://raw.githubusercontent.com/GeoAdaptive/DE_V3s/3e3b23b8c15806ba3e1f7cc9879b9b51bcf8a152/data/INFR_4SUPER_SCL.geojson';

var PmnSchoolsUrl = '';
var IncSchoolsUrl = '';

var PrimaryHealthcareUrl = 'https://raw.githubusercontent.com/GeoAdaptive/DE_V3/master/data/hospital_apop.geojson';
...
var PrimaryRoadsUrl = 'https://raw.githubusercontent.com/GeoAdaptive/DE_V3/master/data/roads_apop.geojson';
...
//SOCIAL
//TRANSPORTATION
var GAP_transcoverageUrl = 'https://raw.githubusercontent.com/GeoAdaptive/DE_V3/master/data/GAP1_areas_low_occupancy.geojson';
var GAP_povertyurl = 'https://raw.githubusercontent.com/GeoAdaptive/DE_V3/master/data/GAP1_POVERTY.geojson';
var GAP_lowmatriculationurl = 'https://raw.githubusercontent.com/GeoAdaptive/DE_V3/master/data/GAP1_LOWMATRICULATION.geojson';
...
//EDUCATION GAP AREAS
var GAP_educoverageUrl = 'https://raw.githubusercontent.com/GeoAdaptive/DE_V3/master/data/GAP1_low_pct_pavement.geojson';
var GAP_roadcoverageUrl = 'https://raw.githubusercontent.com/GeoAdaptive/DE_V3/master/data/GAP1_ROADCOVERAGE.geojson';
var GAP_electricUrl = 'https://raw.githubusercontent.com/GeoAdaptive/DE_V3/master/data/GAP1_LOWELECTRIC.geojson';
...
// Enrivonmental
var GAP_hthcoverageUrl = 'https://raw.githubusercontent.com/GeoAdaptive/DE_V3/master/data/GAP1_fires_change_forestcover.geojson';
...
//gap data definitions
var parsedData_poverty;
var parsedData_lowmatric;
var parsedData_roadcoverag;
var parsedData_electric;
// var parsedData_roadcoverag;
...
var portsurl = 'https://raw.githubusercontent.com/GeoAdaptive/DE_V3/master/data/ports_apop.geojson';
//THE
var hospitalurl = 'https://raw.githubusercontent.com/GeoAdaptive/DE_V3/master/data/hospital_apop.geojson';
//THE
var middleschoolsurl = 'https://raw.githubusercontent.com/GeoAdaptive/DE_V3/master/data/edu_media.geojson';
//THE ROADS
var OProadsurl = 'https://raw.githubusercontent.com/GeoAdaptive/DE_V3/master/data/infr_carreteras_op_osm_ibge_2015_bra.geojson';
var AProadsurl = 'https://raw.githubusercontent.com/GeoAdaptive/DE_V3/master/data/infr_primary_road.geojson';

var parsedData_ports;
var parsedData_hospitals;
var parsedData_middleschools;
var parsedData_roadsAP;
var parsedData_roadsOP;
...
$(document).ready(function(){
  $.ajax(portsurl).done(function(data){
    ...
    var defaultboundary = L.geoJson(parsedData_ports,
      {
...
$(document).ready(function(){
  $.ajax(hospitalurl).done(function(data){
    parsedData_hospitals = JSON.parse(data);
    console.log(parsedData_hospitals);
    console.log("parsed");

    //SET THE DEFAULT COUNTRY MAP FIRST
    var defaultboundary = L.geoJson(parsedData_hospitals,
      {
        style: extrahighlightStyle,
        pointToLayer: function (feature, latlng) {
          return new L.Point(latlng, {
          });
        },
        ...
        Hospitals.push(defaultboundary);
        console.log("Hospitals generated.");
  })
})
...
$(document).ready(function(){
  $.ajax(MiddleSchoolsUrl).done(function(data){
    ...
    //SET THE DEFAULT COUNTRY MAP FIRST
    var defaultboundary = L.geoJson(parsedData_Middleschools,
      {
        style: highlightStyle,
        pointToLayer: function (feature, latlng) {
          return new L.Point(latlng, {
        ...
        Middleschools.push(defaultboundary);
        console.log("middle schools generated.");
  })
})
...
$(document).ready(function(){
  $.ajax(AProadsurl).done(function(data){
    parsedData_roadsAP = JSON.parse(data);
    console.log(parsedData_roadsAP);
    console.log("parsed");

    //SET THE DEFAULT COUNTRY MAP FIRST
    var defaultboundary = L.geoJson(parsedData_roadsAP,
      {
        style: {
        color: '#fff000',
        weight:0.8,
        ...
        roadsAP.push(defaultboundary);
        console.log("roadsAP generated.");
  })
})

$(document).ready(function(){
  $.ajax(OProadsurl).done(function(data){
    parsedData_roadsOP = JSON.parse(data);
    console.log(parsedData_roadsOP);
    console.log("parsed");

    //SET THE DEFAULT COUNTRY MAP FIRST
    var defaultboundary = L.geoJson(parsedData_roadsOP,
      {
        style: {
        color: '#fff000',
        weight:0.8,
        ...
        roadsOP.push(defaultboundary);
        console.log("roads OP generated.");
  })
})


//The Optimize
var Hondurasurl = 'https://github.com/GeoAdaptive/DE_V3/blob/master/data/hnd_boundary_adm0.geojson';
var Guatemalaurl = 'https://raw.githubusercontent.com/GeoAdaptive/DevelopmentExplorer/master/data/Guatemala_1.geojson';
var Salvadorurl = 'https://raw.githubusercontent.com/GeoAdaptive/DevelopmentExplorer/master/data/SalVardo.geojson';
...
//The OP municipalities on Brazil side
var OP_muniurl ='https://raw.githubusercontent.com/GeoAdaptive/DE_V3/master/data/adm_municipios_op_ibge_2015_bra.geojson';
var parsedData_OPmuni;
var OP_muni = [];

$(document).ready(function(){
  $.ajax(OP_muniurl).done(function(data){
    parsedData_OPmuni = JSON.parse(data);
    console.log(parsedData_OPmuni);
    console.log("parsed");

    //SET THE DEFAULT COUNTRY MAP FIRST
    var defaultboundary = L.geoJson(parsedData_OPmuni,
      {
        style: OPmunistyle,
        pointToLayer: function (feature, latlng) {
          return new L.Polygon(latlng, {
        ...
        onEachFeature: function(feature,layer){
          ...
          layer.bindPopup(
            "<b>Name: </b>" +
            "Oeste Paranaense </br>" +
            "</br><button class='btn btn-light my-2 my-sm-0' style='font-size:12px;' onclick='tableToPDF5()';return true;'>Download Report</button>"
          )
        ...
        OP_muni.push(defaultboundary);
        console.log("OP municipality boundary generated.");
  })
})


$(document).ready(function(){
  $.ajax(AP_muniurl).done(function(data){
    parsedData_APmuni = JSON.parse(data);
    console.log(parsedData_APmuni);
    console.log("parsed");

    //SET THE DEFAULT COUNTRY MAP FIRST
    var defaultboundary = L.geoJson(parsedData_APmuni,
      {
        style: APmunistyle,
        pointToLayer: function (feature, latlng) {
          return new L.Polygon(latlng, {
        ...
        onEachFeature: function(feature,layer){
          ...
          "</div>" +
          "<b>" +
          "<span id='category'>" + '<style>#category{color:#fff; font-weight:bold; background-color:#2E86C1; padding: 5px;}</style>' + feature.properties.dist_desc + "</b>" + "</span>" + "</div>" +
          "<br>" + "<table style='width:100%'>" +
          // "<tr>" + "<td>Population (2002): </td>" + "<td>"+ feature.properties.Cen_2002.toFixed(0) + "</td>" + "</tr>" +
          // "<tr>" + "<td>Population (2015): </td>" + "<td>"+ feature.properties.Pro_2015.toFixed(0) + "</td>" + "</tr>" +
          // "<tr>" + "<td>Pop density: </td>" + "<td>"+ (feature.properties.Pro_2015 / feature.properties.Total_area).toFixed(3) + "per sq km</td>" + "</tr>" +
        ...
        AP_muni.push(defaultboundary);
        console.log("AP municipality boundary generated.");
  })
})
    ...
    var defaultboundary = L.geoJson(parsedData_AP,
      {
        ...
        onEachFeature: function(feature,layer){
          layer.bindPopup(
            "<b>Name: </b>" +
            "Alto Paraná </br>" +
            "</br><button class='btn btn-light my-2 my-sm-0' style='font-size:12px;' onclick='tableToPDF6()';return true;'>Download Report</button>"
          )
...
$(document).ready(function(){
  $.ajax(PrimaryHealthcareUrl).done(function(data){
    ...
    var itemB = L.geoJson(parsedData_PrimaryHealthcare,
      {
        style: {opacity:0.45,width:0.03,color:'#237000'},
        pointToLayer: function (feature, latlng) {
          return new L.circleMarker(latlng, {
            radius:2,
            weight:1,
    ...
    var itemB = L.geoJson(parsedData_District,
      {
        ...
        onEachFeature: function(feature,layer){
          layer.bindPopup(
            ...
            "</br><button class='btn btn-light my-2 my-sm-0' style='font-size:12px;' onclick='tableToPDF_muni()'>Download Report</button>"
            ,
...
$(document).ready(function(){
  $.ajax(SevenDistricturl).done(function(data){
    parsedData_sevendist= JSON.parse(data);
    console.log(parsedData_sevendist);
    console.log("parsed");

    //SET THE DEFAULT COUNTRY MAP FIRST
    var defaultboundary = L.geoJson(parsedData_sevendist,
      {
        style: highlightStyle,
        pointToLayer: function (feature, latlng) {
          return new L.Point(latlng, {
...
//Poverty
$(document).ready(function(){
  $.ajax(GAP_povertyurl).done(function(data){
    parsedData_poverty = JSON.parse(data);
    console.log(parsedData_poverty);
    console.log("parsed");
    //SET THE DEFAULT COUNTRY MAP FIRST
    var itemB = L.geoJson(parsedData_poverty,
      {
        style: gapCoverageStyle,
        pointToLayer: function (feature, latlng) {
          return new L.Polygon(latlng, {
        ...
        itemB.eachLayer(eachFeatureFunction);
        povertyGap.push(itemB);
        console.log("povety gap generated.");
  })
})


$(document).ready(function(){
  $.ajax(GAP_lowmatriculationurl).done(function(data){
    parsedData_lowmatric = JSON.parse(data);
    console.log(parsedData_lowmatric);
    console.log("parsed");
    //SET THE DEFAULT COUNTRY MAP FIRST
    var itemB = L.geoJson(parsedData_lowmatric,
      {
        style: gapCoverageStyle,
        pointToLayer: function (feature, latlng) {
          return new L.Polygon(latlng, {
...
$(document).ready(function(){
  $.ajax(GAP_roadcoverageUrl).done(function(data){
    parsedData_roadcoverag = JSON.parse(data);
    console.log(parsedData_roadcoverag);
    console.log("parsed");
    //SET THE DEFAULT COUNTRY MAP FIRST
    var itemB = L.geoJson(parsedData_roadcoverag,
      {
        style: gapCoverageStyle,
        pointToLayer: function (feature, latlng) {
          return new L.Polygon(latlng, {
        ...
        itemB.eachLayer(eachFeatureFunction);
        roadcoverGap.push(itemB);
        console.log("road coverage gap generated.");
  })
})
...
$(document).ready(function(){
  $.ajax(GAP_electricUrl).done(function(data){
    parsedData_electric = JSON.parse(data);
    console.log(parsedData_electric);
    console.log("parsed");
    //SET THE DEFAULT COUNTRY MAP FIRST
    var itemB = L.geoJson(parsedData_electric,
      {
        style: gapCoverageStyle,
        pointToLayer: function (feature, latlng) {
          return new L.Polygon(latlng, {
        ...
        itemB.eachLayer(eachFeatureFunction);
        electricGap.push(itemB);
        console.log("electric coverage gap generated.");
  })
})
...
$('#gaptitle2').click(function(){
  ...
  if(document.getElementById('g2b').style.display == "block"){
    ...
    _.each(povertyGap,function(layer){
      map.removeLayer(layer);
    });
...
$('#gaptitle3').click(function(){
  ...
  if(document.getElementById('g3b').style.display == "block"){
    ...
    _.each(lowmatricGap,function(layer){
      map.removeLayer(layer);
    });
...
$('#gaptitle5').click(function(){
  ...
  if(document.getElementById('g5b').style.display == "block"){
    ...
    _.each(roadcoverGap,function(layer){
      map.removeLayer(layer);
    });
...
$('#gaptitle6').click(function(){
  ...
  if(document.getElementById('g6b').style.display == "block"){
    ...
    _.each(electricGap,function(layer){
      map.removeLayer(layer);
    });
